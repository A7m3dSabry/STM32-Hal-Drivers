...
typedef enum {
    ...
    Timers_A_Interrupts_CaptureCompare2 = (TIMERS_CC2IE_ENABLE << TIMERS_CC2IE_POS),
    Timers_A_Interrupts_CaptureCompare3 = (TIMERS_CC3IE_ENABLE << TIMERS_CC3IE_POS),
    Timers_A_Interrupts_CaptureCompare4 = (TIMERS_CC4IE_ENABLE << TIMERS_CC4IE_POS),
