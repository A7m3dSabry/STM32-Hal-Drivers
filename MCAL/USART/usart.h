...
#include "gpio.h"
#include "LIB/Patterns/patterns.h"

/**************	Section: Macro Definitions Declarations *****/
/**************	Section: Macro Functions Declarations *******/


#define __HAL_USART_BaudRateCalculation(baudrate)   ((uint32_t) CPU_FREQ/(baudrate))
...
uint32_t HAL_USART_BaudRateCalculation(const uint32_t baudRate);
